...
import datetime
# Khoi tao logging MOT LAN duy nhat khi import train.py.
# - level=logging.DEBUG  : file log se chua toan bo chi tiet tung playout (P, Q, u, expand, backup)
# - console_level=logging.INFO : man hinh chi hien tom tat (ket qua tung nuoc di, tung ván, tung epoch)
# Neu muon xem chi tiet playout ngay tren console, doi console_level=logging.DEBUG
# va nen giam self.n_playout xuong con vai chuc de khong bi tran man hinh.
